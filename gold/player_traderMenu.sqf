...
TraderDialogShowPrices = {
	...
	ctrlSetText [TraderDialogBuyPrice, format["%1 %2", [_item select 2] call BIS_fnc_numberText, Coins]];

	ctrlEnable [TraderDialogBuyBtn, true];

	ctrlSetText [TraderDialogSellPrice, format["%1 %2", [_item select 5] call BIS_fnc_numberText, Coins]];
};
